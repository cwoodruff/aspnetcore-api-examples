...
[ApiVersion("1.0")]
public class MediaTypeController(IChinookSupervisor chinookSupervisor, ILogger<MediaTypeController> logger)
    : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int pageSize)
    {
        try
        {
            var mediaTypes = await chinookSupervisor.GetAllMediaType(pageNumber, pageSize);
        ...
        {
            logger.LogError($"Something went wrong inside the MediaTypeController Get action: {ex}");
    ...
    public async Task<ActionResult<MediaTypeApiModel>> Get(int id)
    {
        try
        {
            var mediaType = await chinookSupervisor.GetMediaTypeById(id);
        ...
        {
            logger.LogError($"Something went wrong inside the MediaTypeController GetById action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<MediaTypeApiModel>> Post([FromBody] MediaTypeApiModel input)
    {
        try
        {
            ...
            return Ok(await chinookSupervisor.AddMediaType(input));
        }
        catch (ValidationException ex)
        {
            logger.LogError($"Something went wrong inside the MediaTypeController Add MediaType action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<MediaTypeApiModel>> Put(int id, [FromBody] MediaTypeApiModel input)
    {
        try
        {
            ...
            return Ok(await chinookSupervisor.UpdateMediaType(input));
        }
        catch (ValidationException ex)
        {
            logger.LogError($"Something went wrong inside the MediaTypeController Update MediaType action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult> Delete(int id)
    {
        try
        {
            return Ok(await chinookSupervisor.DeleteMediaType(id));
        }
        catch (Exception ex)
        {
            logger.LogError($"Something went wrong inside the MediaTypeController Delete action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
