...
[ApiVersion("1.0")]
public class EmployeeController(IChinookSupervisor chinookSupervisor, ILogger<EmployeeController> logger)
    : ControllerBase
{
    [HttpGet]
        ...
        [FromQuery] int pageSize)
    {
        try
        {
            var employees = await chinookSupervisor.GetAllEmployee(pageNumber, pageSize);
        ...
        {
            logger.LogError($"Something went wrong inside the EmployeeController Get action: {ex}");
    ...
    public async Task<ActionResult<EmployeeApiModel>> Get(int id)
    {
        try
        {
            var employee = await chinookSupervisor.GetEmployeeById(id);
        ...
        {
            logger.LogError($"Something went wrong inside the EmployeeController GetById action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<EmployeeApiModel>> Post([FromBody] EmployeeApiModel input)
    {
        try
        {
            ...
            return Ok(await chinookSupervisor.AddEmployee(input));
        }
        catch (ValidationException ex)
        {
            logger.LogError($"Something went wrong inside the EmployeeController Add Employee action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<EmployeeApiModel>> Put(int id, [FromBody] EmployeeApiModel input)
    {
        try
        {
            ...
            return Ok(await chinookSupervisor.UpdateEmployee(input));
        }
        catch (ValidationException ex)
        {
            logger.LogError($"Something went wrong inside the EmployeeController Update Employee action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult> Delete(int id)
    {
        try
        {
            return Ok(await chinookSupervisor.DeleteEmployee(id));
        }
        catch (Exception ex)
        {
            logger.LogError($"Something went wrong inside the EmployeeController Delete action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<EmployeeApiModel>> GetReportsTo(int id)
    {
        ...
        {
            logger.LogError($"Something went wrong inside the EmployeeController GetReportsTo action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
    ...
    public async Task<ActionResult<PagedList<EmployeeApiModel>>> GetDirectReports(int id)
    {
        try
        {
            var employees = await chinookSupervisor.GetDirectReports(id);
        ...
        {
            logger.LogError($"Something went wrong inside the EmployeeController GetDirectReports action: {ex}");
            return StatusCode((int)HttpStatusCode.InternalServerError,
